...
export default function VenueProfile() {
  ...
  const openMaps = () => {
    if (venue.google_maps_link) {
        ...
        window.open(`https://www.google.com/maps/search/?api=1&query=${venue.name} ${venue.location}`, '_blank')
    }
  }
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
            <div className="flex-1">
                <div className="flex gap-2 mb-4">
                    {venue.instagram && (
                        <a href={`https://instagram.com/${venue.instagram}`} target="_blank" className="p-2 bg-pink-50 text-pink-600 rounded-full hover:bg-pink-100">
            ...
            <div className="flex flex-col gap-3 min-w-[180px]">
                ...
                <div className="text-center">
                    <div className="flex items-center gap-1 justify-center bg-yellow-50 px-3 py-1 rounded-lg border border-yellow-100 inline-flex">
                            ...
                            <Link href={`/events/${event.id}`} key={event.id}>
                                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 hover:border-blue-300 transition-all flex gap-4 cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <Badge className="mt-2 bg-blue-600">Book Now</Badge>
                                    </div>
                                </div>
                            </Link>
                        ))}
